        ...
        <div className="overflow-hidden  py-24 sm:py-32">
            <div className="mx-auto max-w-2xl px-6 lg:max-w-7xl lg:px-8">
                <div className="max-w-4xl">
                    <HeaderText as="h2" className="mt-2 text-pretty font-medium tracking-tight text-header-text font-serif">
                        On a mission to fill this in with something meaningful
                    </HeaderText>
                    <BodyText className="mt-6 text-balance text-xl/8 text-body-text">
                ...
                <section className="mt-20 grid grid-cols-1 lg:grid-cols-2 lg:gap-x-8 lg:gap-y-16">
                    <div className="lg:pr-8">
                        <HeaderText variant="small" className="mt-2 text-pretty font-medium tracking-tight text-header-text font-serif">Our mission</HeaderText>
                    ...
                    <div className="max-lg:mt-16 lg:col-span-1">
                        ...
                        <dl className="mt-6 grid grid-cols-1 gap-x-8 gap-y-4 sm:grid-cols-2">
                            <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
                                <dt className="text-sm/6 text-body-text">Raised</dt>
                                <dd className="order-first text-6xl font-semibold tracking-tight">
                                    $<span>150</span>M
                                </dd>
                            </div>
                            <div className="flex flex-col gap-y-2 border-b border-dotted border-gray-200 pb-4">
                                <dt className="text-sm/6 text-body-text">Companies</dt>
                                <dd className="order-first text-6xl font-semibold tracking-tight">
                                    <span>30</span>K
                                </dd>
                            </div>
                            <div className="flex flex-col gap-y-2 max-sm:border-b max-sm:border-dotted max-sm:border-gray-200 max-sm:pb-4">
                                <dt className="text-sm/6 text-body-text">Deals Closed</dt>
                                <dd className="order-first text-6xl font-semibold tracking-tight">
                                    <span>1.5</span>M
                                </dd>
                            </div>
                            <div className="flex flex-col gap-y-2">
                                <dt className="text-sm/6 text-body-text">Leads Generated</dt>
                                <dd className="order-first text-6xl font-semibold tracking-tight">
                                    <span>200</span>M
                                </dd>
                            </div>
