...
export default function Location() {
  return (
    <div className="h-svh">
        {/* <Row
        title='Proudly Serving the Conneticut Community'
        description='We are proud to serve the Connecticut community with our top-notch services. Our team is dedicated to providing the best care possible.'
              imageSrc='/images/connecticut.png'
        
              className='mx-12 py-24'
