...
const postGeneralInstructions = [
    ...
    {
        title: "No Smoking or Straws",
        content:
            "Do not smoke, use tobacco products, or drink through a straw for at least one week. The suction can dislodge the blood clot and delay healing (dry socket).",
    },
]
        ...
        <div className="px-6 py-16 max-w-4xl mx-auto space-y-16 pt-40">
            ...
            <section className="text-center space-y-4 py-20">
                ...
                <div className="flex flex-wrap justify-center gap-4">
                    <Button text="Download PDF" href="/downloads/post-op-instructions.pdf" />
                    <Button text="Instrucciones (Español)" href="/downloads/instrucciones-postoperatorias.pdf" />
                </div>
            </section>

            {/* General Post-Operative Instructions */}
            <section className="space-y-6">
                <HeaderText className="font-medium font-serif text-header-text">
                    General Post-Operative Instructions
                </HeaderText>
            ...
            <section className="space-y-6">
                ...
                <BodyText className="text-body-text">
                    <strong>Diet:</strong> Stick to soft, cool foods for the first 48–72 hours (e.g., yogurt,
                    applesauce, smoothies, mashed potatoes). Avoid hot, spicy, crunchy, or hard foods
                    that can irritate the surgical site.
                </BodyText>
                <BodyText className="text-body-text">
                    <strong>Oral Hygiene:</strong> Do not rinse or spit forcefully for the first 24 hours.
