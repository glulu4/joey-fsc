...
//         role: 'Senior Designer',
//         imageUrl:
//             '/images/profiles/dr-sal-profile.webp',
//         bio: `
// Dr. Florio graduated from the State University of New York at Stony Brook in 1986. He
// then attended the Medical College of Virginia where he received a Doctor of Dental
// Surgery (DDS) degree in 1990. He continued his education after being accepted to the
// University of Texas Southwestern Medical Center dual degree program earning his
// Doctor of Medicine (MD) degree in 1993. He spent the next year completing an
// internship in General Surgery, then concluded his advanced training in Oral and
// Maxillofacial Surgery in 1996. His education included training in facial trauma, facial
// reconstruction, pathology, dentofacial deformities, anesthesia and cosmetic surgery.
// He is certified in Basic Life Support, Advanced Cardiac Life Support, Pediatric
// Advanced Life Support, and Advanced Trauma Life Support.
// Dr. Florio is an attending surgeon in the residency training program at Yale New Haven
// Hospital within the department of Oral and Maxillofacial Surgery. He is the chairman
// of the Clinical Competency Committee, and a member of the Admissions Committee.
// He opened his private practice, The Facial Surgery Center located in Trumbull, CT in
// August of 1996.

// <strong>His professional credentials include:</strong>
...
// Dr. Florio resides in Fairfield County, CT with his wife and 2 children. He enjoys
// playing fishing, traveling, motorsports, and spending time outdoors with his friends and
// family.
//         `,
//     },
//     // More people...
...
//   return (
//       <div className='min-h-screen pt-40 sm:pt-52 sm:w-4/6 mx-auto '>
...
//           <ul
//               role="list"
//               className=" flex flex-col mx-auto sm:mt-20  lg:gap-8"
//           >
//               {doctors.map((person) => (
...
//                         width={208}
//                         height={260}
//                        src={person.imageUrl} className="ring-4 ring-white object-cover shadow-lg mx-auto size-30 rounded-full md:size-72" />
                      
//                       <div className='text-center'>
//                           <HeaderText variant='small' className="my-6 sm:my-8 font-medium tracking-tight text-header-text font-serif">
//                               {person.name}
//                           </HeaderText>
